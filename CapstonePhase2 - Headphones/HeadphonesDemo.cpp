...
int main(int argc, char *argv[])
{
	...
	do {
		...
		cout << "** 1)  Add a new pair of headphones to Inventory                      **" << endl;
		cout << "** 2)  Remove headphones from Inventory                               **" << endl;
		cout << "** 3)  Display all headphones in Inventory                            **" << endl;
        cout << "** 4)  Update headphones(based on id) in Inventory                    **" << endl;
		cout << "** 5)  Exit                                                           **" << endl;
		cout << "************************************************************************" << endl;
		cout << ">> ";
		cin >> choice;
		...
		case 1:
		{
            ...
            Headphones tb (model, brand, driverSize, quantity, price, impedance);
			//add to list
            if (tl.addTech(tb))
                cout << "Headphones added successfully!" << endl;
            else
		...
		case 2:
			...
			cin >> id;
            if (tl.removeTech(id))
                cout << "Headphones removed successfully!" << endl;
            else
        ...
        case 3:
            ...
            if (tl.updateTech(id, model, brand, driverSize, quantity, price, impedance))
				cout << "~~~Headphones updated successfully!~~~" << endl;
			else
				cout << "~~~Failed to update Headphones from Inventory~~~" << endl;
            break;
		case 4:
            cout << tl << endl;
			break;
